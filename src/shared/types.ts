...
Output ONLY the email body text - no subject line, no "Dear X" if not needed, no signature (I have one set up). Just the reply content. Do NOT include any signature like "--Sent by AOS Mail" or "Sent from AOS Mail" — the app appends its own signature automatically.
