...
export function MorningBriefing({ onDismissed }: MorningBriefingProps) {
  ...
  const dismissMutation = useMutation({
    ...
    onSuccess: () => {
      // Invalidate so the parent re-fetches and unmounts us.
  ...
  // Friendly greeting based on local time-of-day. Keeps the panel from
  // looking robotic on first impression.
  ...
  return (
    <div
      className="flex-1 min-w-0 overflow-y-auto bg-gradient-to-b from-amber-50 via-white to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-900"
      ...
      <div className="max-w-3xl mx-auto px-8 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-sm text-amber-700 dark:text-amber-400 mb-2">
            ...
            <span className="font-medium uppercase tracking-wider text-xs">Morning briefing</span>
          </div>
          <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100">{greeting}.</h1>
          {accountLabel && (
